...
@section('meta_description', 'Política de privacidad de Consultores IT Automation Platform.')
...
<div class="mx-auto max-w-4xl space-y-6 rounded-[2rem] border border-white/10 bg-slate-900/80 p-8 shadow-2xl shadow-blue-950/30">
    <p class="text-xs font-semibold uppercase tracking-[0.28em] text-cyan-200">Privacidad</p>
    <h1 class="text-3xl font-semibold text-white">Política de privacidad</h1>
