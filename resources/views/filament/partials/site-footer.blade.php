<div class="ci-shell-footer">
    <div class="mx-auto flex max-w-7xl flex-col gap-3 rounded-[1.5rem] border border-cyan-400/20 bg-slate-950/95 px-4 py-3 shadow-[0_-12px_40px_rgba(2,6,23,0.45)] backdrop-blur lg:flex-row lg:items-center lg:justify-between">
